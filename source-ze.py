...
import time 
elhypamody = '6024124201'
bot = telebot.TeleBot(Config.TG_BOT_TOKEN)
p3 = types.InlineKeyboardMarkup()
p5 = types.InlineKeyboardButton(text = "سورس بيدو",url="t.me/b_idu")
...
*لا يمكنك ارسال الروابط*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == "المطور" or m == "مطور" or m == "المبرمج":
		p3 = types.InlineKeyboardMarkup()
		e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/k_B_3")
		p3.add(e4)
		h = """[مطور السورس .](t.me/k_B_3)"""
...
نوع الحيوان : {}*""".format(f2,t2,r222,d222),disable_web_page_preview=True,parse_mode="markdown")
	if message.text == "السورس" or message.text == "سورس":
	    ...
	    p3 = types.InlineKeyboardMarkup()
	    e3 = types.InlineKeyboardButton(text = "قناة السورس .",url="t.me/b_idu")
	    e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/k_B_3")
	    p3.add(e3,e4)
	    r = random.choice(url)
	    h = """اهلا بك عزيزي في سورس الشبح
[قناة السورس .](t.me/b_idu)
[مطور السورس .](t.me/k_B_3)"""
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "سورس بيدو",url="t.me/b_idu")
	p3.add(p5)
...
- - - -- - - - - -- - - - -
CH - @b_idu*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "سورس بيدو",url="t.me/b_idu")
	p3.add(p5)
...
- @Sss0s0bot*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	if message.text == "هلو":
		...
		bot.reply_to(message,"اسمي ↫ بيدو افتهم عادد")
